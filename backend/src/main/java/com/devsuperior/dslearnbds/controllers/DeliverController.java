...
public class DeliverController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','INSTRUCTOR')") //hobilitar as role que posso entrar nesse metodo (mais ideal colocar na camada de serviço
    @PutMapping(value = "/{id}")
    public ResponseEntity<Void> saveRevision(@PathVariable Long id, @RequestBody DeliverRevisionDTO dto){
        deliverService.saveDeliver(id, dto);
